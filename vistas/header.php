<?php 
//session_start();
//o confirmar si existe una session creada para no generar conflicto pues ya se 
//crea session al ingresar, si no existe crearla
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="index2.html" class="logo">
                    ...
                    <span class="logo-mini"><b>IT</b> SV</span>
...
<!--                        <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">Otro li</a>
                                <ul class="dropdown-menu">
                                     User image 
                                    <li class="user-header">lista
                                    </li>    
                                </ul>    
                            </li>-->
                        </ul>
